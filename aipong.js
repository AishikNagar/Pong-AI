...
// Our AI will give a one-hot output- [1,0,0],[0,1,0] or [0,0,1]
// We apply tf.argMax(<One hot Output array>) to get the
// Index of the move to be moved. If we subtract 2 from this,
// It transleates to -1, 0, or 1 => left, stay or right
// We will move the paddle 4x<move> to move it 4 pixels in that direction
Computer.prototype.ai_update = function (move = 0) {
  this.paddle.move(4 * move, 0);
};
...
AI.prototype.new_turn = function () {
  ...
  //Train ai for these number of turns-
  if (this.turn > 3) {
    this.train();
